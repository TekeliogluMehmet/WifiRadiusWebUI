...
$l['all']['daloRADIUS'] = "RADIUS 0.9-9";
$l['all']['daloRADIUSVersion'] = "version 0.9-9";
$l['all']['copyright1'] = "RADIUS Yönetim, Raporlama</a>";
$l['all']['copyright2'] = "RADIUS Copyright &copy; 2018 </a> <br/>
Template design by <a href=\"http://www.finder.com.tr\">Finder Yangın</a>.";
$l['all']['ID'] = "ID";
$l['all']['PoolName'] = "Havuz Adı";
$l['all']['CalledStationId'] = "CalledStationId";
$l['all']['CallingStationID'] = "CallingStationID";
$l['all']['ExpiryTime'] = "Expiry Time";
$l['all']['PoolKey'] = "Havuz Anahtarı";

/********************************************************************************/
/* Vendor Attributes related translation                                        */
/********************************************************************************/
$l['all']['Dictionary'] = "Sözlük";
$l['all']['VendorID'] = "Üretici No";
$l['all']['VendorName'] = "Üretici Adı";
$l['all']['VendorAttribute'] = "Üretici Sembol";
$l['all']['RecommendedOP'] = "Önerilen OP";
$l['all']['RecommendedTable'] = "Önerilen Tablo";
$l['all']['RecommendedTooltip'] = "Önerilen Araçkiti";
$l['all']['RecommendedHelper'] = "Önerilen Yardımcı";
/********************************************************************************/

$l['all']['CSVData'] = "CSV-formatlı veri";

$l['all']['CPU'] = "CPU";

/* radius related text */
$l['all']['RADIUSDictionaryPath'] = "RADIUS Sözlük Konumu";


$l['all']['DashboardSecretKey'] = "Pano Gizli Şifresi";
$l['all']['DashboardDebug'] = "Hata Ayıklama";
$l['all']['DashboardDelaySoft'] = "Time in minutes to consider a 'soft' bekleme sınırı";
$l['all']['DashboardDelayHard'] = "Time in minutes to consider a 'hard' bekleme sınırı";



$l['all']['SendWelcomeNotification'] = "Hoş geldin mesajı gönderme";
$l['all']['SMTPServerAddress'] = "SMTP Sunucu Adresi";
$l['all']['SMTPServerPort'] = "SMTP Sunucu Portu";
$l['all']['SMTPServerFromEmail'] = "Gelen EPosta Adresi";

$l['all']['customAttributes'] = "Özel Nitelikler";

$l['all']['UserType'] = "Kullanıcı Tipi";

$l['all']['BatchName'] = "Batch Adı";
$l['all']['BatchStatus'] = "Batch Durumu";

$l['all']['Users'] = "Kullanıcılar";

$l['all']['Compare'] = "Karşılaştır";
$l['all']['Never'] = "Asla";


$l['all']['Section'] = "Bölüm";
$l['all']['Item'] = "Parça-Kalem";
...
$l['all']['RemoveRadacctRecords'] = "Kullanıcı bağlatı kayıtlarını sil";

$l['all']['CleanupSessions'] = "'dan eski oturumları temizle";
$l['all']['DeleteSessions'] = "'dan eski oturumları sil";

$l['all']['StartingDate'] = "Başlangıç Tarihi";
$l['all']['EndingDate'] = "Bitiş Tarihi";

$l['all']['Realm'] = "Alan";
$l['all']['RealmName'] = "Alan Adı";
$l['all']['RealmSecret'] = "Alan Şifresi";
$l['all']['AuthHost'] = "Yetki Sunucusu";
$l['all']['AcctHost'] = "Kayıt Sunucusu";
$l['all']['Ldflag'] = "ldbayrak";
$l['all']['Nostrip'] = "parçalama";
$l['all']['Notrealm'] = "alansız";
$l['all']['Hints'] = "ip uçları";

$l['all']['Proxy'] = "Vekil Sunucu";
$l['all']['ProxyName'] = "Vekil Sunucu adı";
$l['all']['ProxySecret'] = "Vekil Sunucu Şifresi";
$l['all']['DeadTime'] = "Termin Zamanı";
$l['all']['RetryDelay'] = "Tekrarlama Süresi";
$l['all']['RetryCount'] = "tekrarlama Adeti";
$l['all']['DefaultFallback'] = "Varsayılan geri çekilme";
...
$l['all']['WifiKey'] = "Wifi Şifre";
$l['all']['WifiChannel'] = "Wifi Kanal";

$l['all']['CheckinTime'] = "Son Giriş";
...
$l['all']['PasswordType'] = "Şifreleme Tipi";
$l['all']['IPAddress'] = "IP Adresi";
$l['all']['Profile'] = "Profil";
$l['all']['Group'] = "Grup";
$l['all']['Groupname'] = "Grup Adı";
$l['all']['ProfilePriority'] = "Profil Önceliği";
$l['all']['GroupPriority'] = "Grup Önceliği";
$l['all']['CurrentGroupname'] = "Mevcut Grup Adı";
...
$l['all']['MaxTimeExpiration'] = "En son Zaman / Sona erme";
$l['all']['UsedTime'] = "Kullanılan Zaman";
$l['all']['Status'] = "Durum";
$l['all']['Usage'] = "Kullanım";
$l['all']['StartTime'] = "Başlangıç Zamanı";
$l['all']['StopTime'] = "Bitiş Zamanı";
$l['all']['TotalTime'] = "Toplam Zaman";
$l['all']['TotalTraffic'] = "Toplam Trafik";
$l['all']['Bytes'] = "Bytes";
$l['all']['Upload'] = "Yükleme";
$l['all']['Download'] = "İndirme";
$l['all']['Rollback'] = "Geri-Püskürtme";
$l['all']['Termination'] = "Termin";
$l['all']['NASIPAddress'] = "NAS IP Adresi";
$l['all']['NASShortName'] = "NAS Kısa Adı";
$l['all']['Action'] = "Aksiyon";
$l['all']['UniqueUsers'] = "Tekil Kullanıcı";
$l['all']['TotalHits'] = "Toplam Tepe";
$l['all']['AverageTime'] = "Ortalama Zaman";
$l['all']['Records'] = "Kayıtlar";
$l['all']['Summary'] = "Toplama";
$l['all']['Statistics'] = "İstatistik";
$l['all']['Credit'] = "Kredi";
$l['all']['Used'] = "Kullanım";
$l['all']['LeftTime'] = "Beklenen Zaman";
$l['all']['LeftPercent'] = "% zaman geçti";
$l['all']['TotalSessions'] = "Oturumlar Toplamı";
$l['all']['LastLoginTime'] = "Son Giriş Zamanı";
$l['all']['TotalSessionTime'] = "Oturum Toplam zamanı";
$l['all']['RateName'] = "Hız Adı";
$l['all']['RateType'] = "Hız Tipi";
$l['all']['RateCost'] = "Hız Maliyeti";
$l['all']['Billed'] = "Ödendi";
$l['all']['TotalUsers'] = "Toplam Kullanıcı";
$l['all']['ActiveUsers'] = "Aktif Kullanıcılar";
$l['all']['TotalBilled'] = "Alacak Toplamı";
$l['all']['TotalPayed'] = "Ödeme Toplamı";
$l['all']['Balance'] = "Fark";
$l['all']['CardBank'] = "Banka Kartı";
$l['all']['Type'] = "Tip";
$l['all']['CardBank'] = "BankaKartı";
$l['all']['MACAddress'] = "MAC Adresi";
$l['all']['Geocode'] = "GeoKodu";
$l['all']['PINCode'] = "PIN Kodu";
$l['all']['CreationDate'] = "Oluşturma Tarihi";
$l['all']['CreationBy'] = "tarafından oluşturuldu";
$l['all']['UpdateDate'] = "Değiştirme Tarihi";
$l['all']['UpdateBy'] = "tarafından değiştirildi.";

$l['all']['Discount'] = "İnddirim";
$l['all']['BillAmount'] = "Ödeme Toplamı";
$l['all']['BillAction'] = "Ödeme Aksiyonu";
$l['all']['BillPerformer'] = "Ödeme Yapan";
$l['all']['BillReason'] = "Ödeme Nedeni";
$l['all']['Lead'] = "Lead";
$l['all']['Coupon'] = "Coupon";
...
$l['Tooltip']['UserEdit'] = "Kullanıcı Değişiklik";
...
$l['button']['NewUsers'] = "Yeni Kullanıcılar";
...
$l['button']['SearchVendorAttribute'] = "Ara Attribute";
...
$l['button']['ListUsers'] = "Kullanıcı Listele";
...
$l['button']['EditUser'] = "Kullanıcı Değişiklik";
...
$l['button']['ListProfiles'] = "Profil Listesi";
$l['button']['NewProfile'] = "Yeni Profil";
$l['button']['EditProfile'] = "Profil Değiştir";
$l['button']['DuplicateProfile'] = "Profil Çoğalt";
$l['button']['RemoveProfile'] = "Profil Sil";
...
$l['button']['OnlineUsers'] = "Sistemdeki Kullanıcılar";
$l['button']['LastConnectionAttempts'] = "Son Bağlananlar";
$l['button']['TopUser'] = "En Kullanıcılar";
$l['button']['History'] = "Geçmiş";

$l['button']['ServerStatus'] = "Sunucu Durumu";
$l['button']['ServicesStatus'] = "Servis Durumu";

$l['button']['daloRADIUSLog'] = "Wifi RADIUS Kayıt dökümü";
$l['button']['RadiusLog'] = "Radius Kayıtlar";
$l['button']['SystemLog'] = "Sistem Kayıtlar";
$l['button']['BootLog'] = "Açılış Kayıtları";

$l['button']['UserLogins'] = "Kullanıcı Girişileri";
$l['button']['UserDownloads'] = "Kullanıcı Alım";
$l['button']['UserUploads'] = "Kullanıcı Gönderim";
$l['button']['TotalLogins'] = "Toplam Giriş";
$l['button']['TotalTraffic'] = "Toplam Trafik";
$l['button']['LoggedUsers'] = "Giriş yapmış Kullanıcı";
...
$l['title']['daloRADIUSTables'] = "Wifi RADIUS Tables";
...
$l['title']['MacVlan'] = "Mac&Username Based Vlan";
...
$l['title']['Macname'] = "Mac Address";
$l['title']['MacVLAN'] = "VLAN";
$l['title']['VPN'] = "VPN";
...
$l['text']['LoginRequired'] = "Giriş Gerektirir";
$l['text']['LoginPlease'] = "Lütfen Giriş";
...
$l['ContactInfo']['FirstName'] = "Adı";
$l['ContactInfo']['LastName'] = "Soyadı";
$l['ContactInfo']['Email'] = "Eposta";
$l['ContactInfo']['Department'] = "Departman";
$l['ContactInfo']['WorkPhone'] = "İş Tel";
$l['ContactInfo']['HomePhone'] = "Ev Tel";
$l['ContactInfo']['Phone'] = "Tel";
$l['ContactInfo']['MobilePhone'] = "GSM";
$l['ContactInfo']['Notes'] = "Not";
$l['ContactInfo']['EnableUserUpdate'] = "Kullanıcı Güncelleme aktif et";
$l['ContactInfo']['EnablePortalLogin'] = "Kullanıcı VPN girişi aktif et";
$l['ContactInfo']['PortalLoginPassword'] = "Kullanıcı VPN şifresi";
...
$l['ContactInfo']['City'] = "Şehir";
$l['ContactInfo']['State'] = "Bölge";
$l['ContactInfo']['Country'] = "Ülke";
$l['ContactInfo']['Zip'] = "PostaKodu";
$l['ContactInfo']['Phone1'] = "Tel 1";
$l['ContactInfo']['Phone2'] = "Tel 2";
$l['ContactInfo']['HotspotType'] = "Hotspot Tip";
$l['ContactInfo']['CompanyWebsite'] = "Şirket Websitesi";
$l['ContactInfo']['CompanyPhone'] = "Şirket Tel";
$l['ContactInfo']['CompanyEmail'] = "Şirket Eposta";
$l['ContactInfo']['CompanyContact'] = "Şirket irtibat";
...
$l['Intro']['mngradproxys.php'] = "Proxys Yönetim";
...
$l['Intro']['mngradrealms.php'] = "Realms Yönetim";
...
$l['Intro']['mngradattributes.php'] = "Vendor's Attributes Yönetim";
...
$l['Intro']['mngradattributessearch.php'] = "Ara Attributes";
...
$l['Intro']['billposedit.php'] = "Kullanıcı Değişiklik";
...
$l['Intro']['graphsalltimelogins.php'] = "Toplam giriş";
$l['Intro']['graphsloggedusers.php'] = "Giriş yapmış Kullanıcı";
$l['Intro']['graphsoveralldownload.php'] = "Kullanıcı Alım";
$l['Intro']['graphsoveralllogins.php'] = "Kullanıcı Girişi";
$l['Intro']['graphsoverallupload.php'] = "Kullanıcı Gönderi";
...
$l['Intro']['repstatserver.php'] = "Sunucu Durum ve Bilgisi";
$l['Intro']['reponline.php'] = "Sistemdeki kullanıcılar";
$l['Intro']['replogssystem.php'] = "Sistem Kayıt dökümü";
$l['Intro']['replogsradius.php'] = "RADIUS Server Logfile";
$l['Intro']['replogsdaloradius.php'] = "Wifi RADIUS Logfile";
$l['Intro']['replogsboot.php'] = "Boot Logfile";
$l['Intro']['replogs.php'] = "Logs";
$l['Intro']['rephb.php'] = "Heartbeat";
$l['Intro']['rephbdashboard.php'] = "Wifi RADIUS NAS Panel";
...
$l['Intro']['repstatus.php'] = "Durum Sayfası";
$l['Intro']['reptopusers.php'] = "En Kullanıcılar";
$l['Intro']['repusername.php'] = "Kullanıcı Listele";

$l['Intro']['mngbatch.php'] = "Create batch users";
$l['Intro']['mngbatchdel.php'] = "Delete batch sessions";

$l['Intro']['mngdel.php'] = "Kullanıcı Sil";
$l['Intro']['mngedit.php'] = "Kullanıcı Detay değişikliği";
$l['Intro']['mnglistall.php'] = "Kullanıcı Listeleme";
$l['Intro']['mngmain.php'] = "Users and Hotspots Yönetim";
$l['Intro']['mngbatch.php'] = "Batch Users Yönetim";
$l['Intro']['mngnew.php'] = "Yeni Kullanıcı";
$l['Intro']['mngnewquick.php'] = "Quick User Add";
$l['Intro']['mngsearch.php'] = "Kullanıcı Ara";
...
$l['Intro']['mngradprofiles.php'] = "Profil Düzenleme";
$l['Intro']['mngradprofilesedit.php'] = "Profil Değiştir";
$l['Intro']['mngradprofilesduplicate.php'] = "Profil Çoğalt";
$l['Intro']['mngradprofilesdel.php'] = "Profil Sil";
$l['Intro']['mngradprofileslist.php'] = "Profil Liste";
$l['Intro']['mngradprofilesnew.php'] = "Yeni Profil";
...
$l['Intro']['mngradgroupreplysearch.php'] = "Ara Group Reply Mapping";
...
$l['Intro']['mngradgroupchecksearch.php'] = "Ara Group Check Mapping";
...
<b>Profiles Yönetim</b> - Manage Profiles for Users by composing a set of Reply Attributes and Check Attributes <br/>
...
<b>Groups Yönetim</b> - Manage Group Reply and Group Check mappings (radgroupreply/radgroupcheck tables).<br/>
...
for convenience reasons and Wifi RADIUS will translate it to %
";
...
<h200><b>Test User Connectivity</b></h200> - Send an Access-Request to the RADIUS Server to check if a user credentials are valid.<br/>
Wifi RADIUS uses the radclient binary utility to perform the test and returns the results of the command after it finishes. <br/>
Wifi RADIUS counts on the radclient binary being available in your \$PATH environment variable, if it is not, please make
...
$l['helpPage']['replogsdaloradius'] = "Monitor Wifi RADIUS's Logfile.";
...
$l['helpPage']['replogs'] = "
<b>Logs</b><br/>
<h200><b>Wifi RADIUS Log</b></h200> - Monitor Wifi RADIUS's Logfile.<br/>
...
";
$l['helpPage']['repmain'] = "
<b>Genel Raporlar</b><br/>
<h200><b>Sistemdeki Kullanıcılar</b></h200> - Provides a listing of all users which are 
...
<h200><b>Logs</b></h200> - Provides access to Wifi RADIUS logfile, FreeRADIUSs logfile, System's logfile and Boot logfile<br/>
<h200><b>Durum</b></h200> - Provides information on server status and RADIUS Components status";
...
$l['helpPage']['repstatus'] = "<b>Durum</b><br/>
<h200><b>Sunucu Durumu</b></h200> - Provides general information about the server itself: CPU Usage, Processes, Uptime, Memory usage, etc.<br/>
<h200><b>RADIUS Durumu</b></h200> - Provides general information about the FreeRADIUS daemon and MySQL Database server";
...
In the Yönetim page you are able to add new hotspot entries to the database where there is also a field
...
Wifi RADIUS application on your server. Once you have obtained that code from Google, simply paste it in the
...
$l['messages']['nomacdefinedforuser'] = "This user has no Macs-Vlan associated with it";
...
$l['menu']['Home'] = "<em>G</em>iriş</a>";
$l['menu']['Managment'] = "<em>Y</em>önetim</a>";
$l['menu']['Reports'] = "<em>R</em>aporlar</a>";
$l['menu']['Accounting'] = "<em>K</em>ayıtlar</a>";
$l['menu']['Billing'] = "<em>B</em>illing</a>";
$l['menu']['Gis'] = "<em>G</em>IS</a>";
$l['menu']['Graphs'] = "Gra<em>f</em>ikler</a>";
$l['menu']['Config'] = "<em>A</em>yar</a>";
